...
int main (int argc, char** argv)
{
  ...
  if (secondchannel>=1 && secondchannel<=8){
	firstchannel == 0;
  }
  else if (secondchannel>=10 && secondchannel<=17){
        firstchannel == 9;
  }
  else if (secondchannel>=19 && secondchannel<=26){
        firstchannel == 18;
  }
  else if (secondchannel>=28 && secondchannel<=34){
	firstchannel == 27;
  }
  else if (secondchannel > 34){
	//????
  }	  
  ...
  while (channelScan and secondchannel_local<35) {
    if (secondchannel>=0) {
      channelScan=false;
